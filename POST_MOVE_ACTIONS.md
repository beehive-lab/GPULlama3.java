...
| [ ] | Rename the repo | GitHub repo settings | `beehive-lab/GPULlama3.java` → `beehive-lab/jllm`. Recommended **before** merging, so the 13 rewritten slug guards actually run on the PR instead of skipping. | |
