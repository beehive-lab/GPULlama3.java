 ...
 */
public class LlamaQ8_0LayersBatchPrefillGeneric implements BatchPrefillTransformerLayerTaskGraphs {
    ...
    public LlamaQ8_0LayersBatchPrefillGeneric(LlamaState state, LlamaTornadoWeights weights, LlamaConfiguration config, int batchSize) {
        this.state = state;
