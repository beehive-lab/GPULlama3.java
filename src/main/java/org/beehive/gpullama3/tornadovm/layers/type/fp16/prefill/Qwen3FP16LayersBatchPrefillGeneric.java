 ...
 */
public class Qwen3FP16LayersBatchPrefillGeneric implements BatchPrefillTransformerLayerTaskGraphs {
    ...
    public Qwen3FP16LayersBatchPrefillGeneric(Qwen3State state, Qwen3TornadoWeights weights,
