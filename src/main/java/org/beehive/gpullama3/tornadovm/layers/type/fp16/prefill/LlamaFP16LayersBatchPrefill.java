...
//            scheduler.addWorkerGrid(p + "batch_ffn_rms_apply",  ffnRmsApplyWorker);  // NEW
//            scheduler.addWorkerGrid(p + "batch_ffn_w1_mma",     mmaFFNWorker);       // NEW
//            scheduler.addWorkerGrid(p + "batch_ffn_w3_mma",     mmaFFNWorker);       // NEW (same grid)
//            scheduler.addWorkerGrid(p + "batch_ffn_swiglu",     swigluWorker);       // NEW
