...
/**
 * Kernel-level screen: device kernel time of the paired-load and one-block-lookahead {@code Q4_0}
 * projections on the production shapes, from the TornadoVM profiler's per-execution event timing,
 * launched alternately after a warm-up.
 *
 ...
 */
public class Qwen35MMAQ4_0PrefetchKernelScreenAccelTest {
    ...
    public void screen() throws Exception {
        ...
        for (int[] shape : SHAPES) {
            ...
            try (TornadoExecutionPlan planA = new TornadoExecutionPlan(original.snapshot());
                ...
                report("paired   n=" + n + " k=" + k, tA);
                report("prefetch n=" + n + " k=" + k, tB);
