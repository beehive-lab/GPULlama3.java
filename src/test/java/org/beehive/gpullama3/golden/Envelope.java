...
/**
 * The provisional reproducibility-envelope gate
 * ({@code verification-gates.md} §Reproducibility-envelope gate).
 *
 * <p>Applies to a configuration recorded as {@code bit_exact: false}. It bounds how far the
 * numbers may drift and asserts the properties that actually change output. It is an
 * accommodation of a known defect, not a relaxed standard: argmax and top-5 must hold exactly,
 * and top-10 is reported so that a widening drift is visible rather than silent.
 */
    ...
    public static final class Report {
        ...
        public String toString() {
            return String.format(
                    ...
                    changed, total, maxAbs, MAX_ABS, maxRel, MAX_REL, argmaxRef, argmaxGot,
                    top5Same ? "same" : "CHANGED", top10Same ? "same" : "CHANGED");
        }
    }
