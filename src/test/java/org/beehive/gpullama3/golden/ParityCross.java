...
public final class ParityCross {
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("free-running token ids: F16 cpu==gpu? %s ; Q8_0 cpu==gpu? %s%n",
    ...
    private static void report(String label, GoldenCapture.Result a, GoldenCapture.Result b) {
        ...
        System.out.printf("%-24s rows=%d worstAbs=%.4f meanAbs=%.5f%n", label, n, worst, meanOfMean / n);
    }
