 ...
 *
 * <p>A pair of tokens per chunk: the narrowest width at which a chunk is a chunk, and the one where a scan that ignored its second row would still look plausible.
 *
...
public class Qwen35BatchedPrefillWidth2ParityAccelTest extends CpuGpuParity {
    ...
    public void qwen3_8_27b_q4_0_batchedPrefillParityAt2() throws Exception {
        assertParityBatched(Fixture.QWEN3_8_27B_Q4_0, Q8_0, 2);
    }
}
