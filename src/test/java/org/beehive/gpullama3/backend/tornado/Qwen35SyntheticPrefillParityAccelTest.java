...
public class Qwen35SyntheticPrefillParityAccelTest {
    ...
    private static FloatTensor copyOf(FloatTensor logits) {
        ...
        return new org.beehive.gpullama3.tensor.standard.ArrayFloatTensor(values);
    }

    private static void assertRow(
            int position, FloatTensor expected, org.beehive.gpullama3.inference.Logits actual) {
        float maxAbs = 0f;
