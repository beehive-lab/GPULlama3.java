...
public class Qwen35SyntheticBatchPrefillParityAccelTest {
    ...
    private static Qwen35State stateForWidth(Qwen35Configuration config, int width) {
        ...
        String previousPhase = System.getProperty("llama.withPrefillDecode");
        ...
        System.setProperty("llama.prefillBatchSize", String.valueOf(Math.max(width, 1)));
        ...
        try {
            ...
            restore("llama.withPrefillDecode", previousPhase);
        }
    }
    ...
    private static float[] copyOf(org.beehive.gpullama3.inference.Logits logits) {
