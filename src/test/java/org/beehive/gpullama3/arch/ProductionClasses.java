 ...
 *
 * <p>Importing is the expensive part of an ArchUnit run, so every rule class reuses this
 * single snapshot. Test classes are excluded: the rules describe the shipped library, and
 * test code is allowed to reach anywhere.
 *
 * <p>Rules and their allowlists are specified in {@code docs/architecture/dependency-rules.md}.
 */
