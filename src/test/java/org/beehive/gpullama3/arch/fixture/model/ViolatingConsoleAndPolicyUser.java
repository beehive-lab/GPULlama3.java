...
/**
 * Deliberate violator for Rules 8a and 16: library-layer code that both prints to the console
 * and depends on the CLI options record. Used only by the self-test.
 */
